...
String title = songTitle.substring(0,101) 
...
WebUI.setText(findTestObject('Object Repository/UploadSong/Page_App nghe nhc/input_Title_songtitle'), title)
...
WebUI.verifyMatch(alert, "Title title too long", true)
